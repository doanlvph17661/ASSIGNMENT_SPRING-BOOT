  ...
  <div class="container-fluid ms-5">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-3" >
           ...
           <li class="nav-item">
          <a class="nav-link fw-bold" href="/Assignment/admin/orders/index">Order</a>
        </li>
         <li class="nav-item">
          <a class="nav-link fw-bold"  href="/Assignment/admin/orderDetail/index">Order Detail</a>
        </li>
      	 ...
      	 <li>
        	<a class="ms-4" href="/Assignment/sp/card">
...
<div class="container-fluid footer bg-light mt-4">
	<div class="row">
		...
		<div class="col-2 ">
			...
			<div class="row">
				<div class="col-6">
					<img class="" src="/Assignment/image/group-qr.jpeg">
				</div>
				<div class="col-6">
